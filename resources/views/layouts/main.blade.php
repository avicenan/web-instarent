...
<html lang="en">
    ...
    <body style="background-color: #F7F7F7">
        ...
        <div class="row justify-content-center m-0">
            <div class="page-container col-lg-10 my-4" style="padding: 0 5%; max-width: 1650px; min-height: 100vh">
                @yield('container')
            </div>
        </div>

        <!-- Footer -->
        <footer id="footer" style="background-color: #D8F3DC; min-height: 500px; " class="mt-5">
