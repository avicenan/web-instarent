...
<div class="col-lg-8">
  ...
  <form method="post" action="/dashboard/vehicles" enctype="multipart/form-data">
      @csrf
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <select class="form-select @error('transmission_id') is-invalid @enderror" name="transmission_id" value={{ old('transmission_id') }}>
          <option disabled selected value> -- select an option -- </option>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('extras') is-invalid @enderror" id="extras" name="extras" rows="3" value={{ old('extras') }}>
